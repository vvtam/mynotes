...
logging.basicConfig(filename='transcodingToTS.log', level=logging.WARNING)
# logging.basicConfig(filename='transcodingToTS.log', level=logging.INFO)
...
# 逐行读取文件，并新建输出路径
    while line:
        ...
        outputdir = os.path.join(os.path.abspath('.'), 'hls', outputdir)
        # 如果输出不在当前目录,需要重新定义
        #output_basedir = ''
